...
<template>
    ...
    <AuthenticatedLayout>
        <template #header><div class="flex items-center justify-between"><h2 class="text-xl font-semibold text-gray-800">Cheltuieli si achizitii</h2><div class="flex gap-2"><a :href="route('admin.expenses.export', filters)" class="rounded-md border border-slate-300 px-3 py-2 text-sm font-semibold text-slate-700">Export Excel</a><Link :href="route('admin.expenses.create')" class="rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white">Cheltuiala noua</Link></div></div></template>
