...
defineProps({ client: Object, openTickets: Number, scheduledWorks: Number, unpaidInvoices: Number, balance: Number, unreadNotifications: Number, recentTickets: Array });
</script>
