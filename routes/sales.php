...
Route::middleware(['auth', 'verified'])->prefix('vanzari')->name('sales.')->group(function () {
    Route::middleware('role_or_permission:admin|vanzari|clients.view|clients.manage|offers.view|offers.manage')->group(function () {
    ...
    Route::middleware('role_or_permission:admin|vanzari|offers.view|offers.manage')->group(function () {
